...
function Header() {
    ...
    window.addEventListener("scroll", function () {
        ...
        // When the scroll is higher than 200 viewport height, add the scroll-header class to a tag with header class
  ...
  return (
    <header className="header">
        <nav className="nav container">
            <a href="index.html" className="nav_logo">Sadman</a>
