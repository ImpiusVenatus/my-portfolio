        ...
        <div className="services_container container grid">
          ...
          <div className="services_content">
            <div>
              ...
              <h3 className="services_title">MERN Stack <br />Developer</h3>
            </div>

            <span className="services_button" onClick={() => toggleTab(2)}>View More<i 
            className="uil uil-arrow-right 
            services_button_icon"></i></span>
            ...
            <div className={toggleState === 2 ? "services_modal active_modal" : "services_modal"}>
              <div className="services_modal_content">
                ...
                <h3 className="services_modal_title">MERN Stack Developer</h3>
                <p className="services_modal_description">
                  Service with more than 2 years of experience. Providing
                  quality work to clients and companies.
                </p>
          ...
          <div className="services_content">
            ...
            <span className="services_button" onClick={() => toggleTab(3)}>View More <i 
            className="uil uil-arrow-right 
            services_button_icon"></i></span>
