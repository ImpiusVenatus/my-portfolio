            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <span className="contact_card_data">hossainsadman39@gmail.com</span>

                        <a href="mailto:hossainsadman39@gmail.com" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button_icon"></i></a>
                    </div>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card_data">+8801717158743</span>

                        <a href="https://wa.me/+8801717158743" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button_icon"></i></a>
                    </div>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card_data">Sadman Hossain</span>

                        <a href="https://www.facebook.com/profile.php?id=100006365620176" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button_icon"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div className="contact_content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact_form">
                    ...
                    <div className="contact_form_div contact_form_area">
                        ...
                        <textarea name="project" className="contact_form_input" cols="30" rows="10" placeholder="Write your project" />
                    </div>
