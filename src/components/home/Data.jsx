  ...
  return (
    <div className="home_data">
        ...
        <div className="home_subtitle">
          ...
          options={{ loop: true }}
          onInit={(typewriter) => {
          typewriter.typeString("Web Developer").pauseFor(2000).deleteAll().typeString("Web Designer").pauseFor(2000).start();
          }}
          />
        </div>
        <p className="home_description">
            I'm a creative designer based in Dhaka and I'm very passionate
